...
func TestCreateTranslation(t *testing.T) {
	...
	assert.Equal(t, 201, w.Code)
	assert.Equal(t, `{"Id":5,"Translation":"testTranslation","Language":"en","Approved":false,"ImprovementNeeded":false}`, w.Body.String())
	...
	assert.Equal(t, `{"Id":5,"Translation":"testTranslation","Language":"en","Approved":false,"ImprovementNeeded":false}`, w2.Body.String())
