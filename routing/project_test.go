...
func TestGetProject(t *testing.T) {
	...
	assert.Equal(t, 200, w.Code)
	assert.Equal(t, `{"Id":1,"Name":"Shared","BaseLanguage":{"IsoCode":"en","Name":"English"},"Languages":[{"IsoCode":"de","Name":"German"},{"IsoCode":"en","Name":"English"}],"Identifiers":[{"Id":1,"Identifier":"key1","Translations":[{"Translation":"translation1","Language":"de","Approved":false}]},{"Id":2,"Identifier":"key2","Translations":[{"Translation":"translation2","Language":"de","Approved":false}]}]}`, w.Body.String())
}
